...
public class CountingSortPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("counting_sort_performance_results.csv")) {
            ...
            for (int dataSize : dataSizes) {
                ...
                for (int i = 0; i < samples; i++) {
                    ...
                    CountingSort.countingSort(arrayCopy, 1000); // Executa Counting Sort Serial
                ...
                for (int threadCount : numThreads) {
                    for (int i = 0; i < samples; i++) {
                        ...
                        ParallelCountingSort countingSortTask = new ParallelCountingSort(arrayCopy, 1000, threadCount);
                        countingSortTask.countingSort();
